    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-5 flex justify-center gap-2">
          ...
          <a href="/" className="rounded-md border border-border px-4 py-2 text-xs">Home</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EliteHosting is a modern PaaS that deploys your Python, Node, or any project from GitHub or a ZIP file. Live logs, private repos, custom env, start/stop controls." },
      { name: "keywords", content: "deploy python, host github repo, deploy zip file, PaaS, python hosting, bot hosting, discord bot hosting" },
      { name: "author", content: "EliteHosting" },
      { property: "og:title", content: "EliteHosting — Deploy code from GitHub or ZIP in seconds" },
      { property: "og:description", content: "Modern PaaS with GitHub & ZIP deploys, live logs, private repos, custom env vars." },
